...
const char* fileNameCachedMeshes    = ".cache/demoscene.meshes";
const char* fileNameCachedMaterials = ".cache/demoscene.materials";
const char* fileNameCachedHierarchy = ".cache/demoscene.scene";
...
int main()
{
  if (!isMeshDataValid(fileNameCachedMeshes) || !isMeshHierarchyValid(fileNameCachedHierarchy) ||
    ...
    loadMeshFile("deps/src/demoscene/san/san-miguel-low-poly.obj", meshData_Exterior, ourScene_Exterior, false);
    loadMeshFile("deps/src/demoscene/room/living_room.obj", meshData_Interior, ourScene_Interior, false);
