...
const char* fileNameCachedMeshes    = ".cache/ch08_sci-fi_container.meshes";
const char* fileNameCachedMaterials = ".cache/ch08_sci-fi_container.materials";
const char* fileNameCachedHierarchy = ".cache/ch08_sci-fi_container.scene";
...
int main()
{
  if (!isMeshDataValid(fileNameCachedMeshes) || !isMeshHierarchyValid(fileNameCachedHierarchy) ||
    ...
    loadMeshFile("data/meshes/sci-fi_container/scene.gltf", meshData, ourScene, true);
