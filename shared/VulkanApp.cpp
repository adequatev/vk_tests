...
: cfg_(cfg)
{
  ...
  window_ = lvk::initWindow("kratos render engine", width, height);
  ...
  imgui_     = std::make_unique<lvk::ImGuiRenderer>(*ctx_, "data/ProggyClean.ttf", 28.0f);
